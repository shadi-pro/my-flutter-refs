  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        ...
        body: Container (
          child :   Image.asset(   // 1- first type of the [Image widget]
            "assets/images/download.png" , // image path/url value 
            
            width: 500 ,
            height: 500 ,
            
            fit : BoxFit.cover, //  [this property will make the image fit the given width and height - but will be corped and not affect on its quality] 
