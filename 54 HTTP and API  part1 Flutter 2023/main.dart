...
// -------------------------------------------
  ...
  // --------------------------
    ...
    46 - [initialState() , Dispose()]     =>  [current lesson ]
       define  both of the  [initialState() , Dispose()]  inside (3) inner pages +  with testing navigtion through diffrent methods [that clearing/not clearing  page form  the qeue  ] 
  ...
  47-  [ PopMenuBottom ]  =>     :
    using the   {PopMenuBottom}  wiht in p 
  ...
  52- [package] [part 2]=>   [ current lesson ]
  //  a) using hte intallled package of [awesome_dilaog ] 
  //  b)   
  // --------------------------
...
import 'package:project/pagetwo.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      // [calling  the imported [Homepage] inside 'home' property to be the first page opened by default ]
      home: Home(),
