/*
 Lessons applied in this application :  
  ...
  20-  [ TextFormField ]  (part 1 - validator )  - 
      (1) examples =>   
        a- First example [Exp1] =>
          
          - implementing assigned logic of all   {TextFormField} inside the Form , by using a one submit button  {MaterialButton}
          - this example including next widgets : 
            1- [(2) {TextFormField} widget] => will include several [ validaton logics ]  for each textformField       
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        ...
        appBar: AppBar(
          title: const Text(' [TextFormField]  widget part 1 : validator  '),
        ),
        ...
        body: Container(
          ...
          child: Form(
            key: formstate,  // [ assign the defined [formstate] variable of the GlobalKey datatype       ]   
            child: Column(
              children: [
                ...
                TextFormField(
                  validator: (value) {
                    ...
                    if (value.length < 3 ) {
                      return 'لا تقبل القيمة المدخلة اكبر من 10 ';
                    }
                ...
                TextFormField(
                  validator: (value) {
                    ...
                    if (value.length > 10 ) {
                      return 'لا تقبل القيمة المدخلة اقل من 3 ';
                    }
                ...
                MaterialButton(
                  ...
                  onPressed: () {
                    // [ if the  textformfield's content is valid ]
                    if (formstate.currentState!.validate()) {   
                      print('valid');
                    } else{
                      // [ if the  textformfield's content is Not valid ]
                      print('Not valid');
                    }   
                  },
                ),
