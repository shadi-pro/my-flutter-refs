...
class _FilterPageState extends State<FilterPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final categories = ['الكل', ...uniqueCategories];
    final types = ['الكل', 'دخل', 'مصروف'];
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(
                  child: Text(
                    'من: ${searchController.minAmount.value.toInt()} ج.م',
                    textAlign: TextAlign.center,
                  ),
                ),
                Expanded(
                  child: Text(
                    'إلى: ${searchController.maxAmount.value.toInt()} ج.م',
                    textAlign: TextAlign.center,
                  ),
                ),
              ],
          ...
          children: [
            ...
            Obx(() {
              ...
              return Column(
                children: [
                  Text(
                    'تم العثور على $filteredCount من أصل $totalCount',
