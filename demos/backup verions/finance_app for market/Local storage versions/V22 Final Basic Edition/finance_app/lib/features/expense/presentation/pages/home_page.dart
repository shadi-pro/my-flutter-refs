...
class HomePage extends StatelessWidget {
  ...
  void _handleMoreOptions(String value) {
    switch (value) {
      case 'goals': // ✅ الأهداف المالية
        Get.to(() => GoalsListPage());
        break;

      case 'budget': // ✅ الميزانية
        Get.to(() => BudgetPage());
        break;
      ...
      case 'backup': // ✅ النسخ الاحتياطي
        Get.to(() => BackupPage());
        break;

      case 'clear_data': // ✅ مسح البيانات
        Get.defaultDialog(
    ...
    return Directionality(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          centerTitle: true,
          actions: [
            // ✅ أيقونة التقارير فقط (تظهر دائماً)
            IconButton(
            ...
            // ✅ كل شيء آخر في القائمة المنبثقة
            PopupMenuButton<String>(
              ...
              itemBuilder: (context) => [
                // الأهداف المالية (الأولوية الأولى)
                PopupMenuItem(
                  value: 'goals',
                  child: Row(
                    children: [
