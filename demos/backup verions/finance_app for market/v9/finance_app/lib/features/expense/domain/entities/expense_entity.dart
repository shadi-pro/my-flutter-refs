...
class ExpenseEntity {
  ...
  ExpenseEntity({
    ...
    required this.paymentMethod,
        ...
        // ✅ إزالة assert للوصف لأنه ليس إجبارياً
  ...
  factory ExpenseEntity.fromMap(Map<String, dynamic> map) {
    try {
      ...
      final descriptionStr = map['description']?.toString() ?? '';
      ...
      // ✅ إرجاع كيان افتراضي بدون رمي استثناء
      return ExpenseEntity(
        amount: 0.0,
