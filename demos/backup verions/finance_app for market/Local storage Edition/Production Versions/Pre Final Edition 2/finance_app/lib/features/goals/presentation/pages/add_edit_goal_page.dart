...
class _AddEditGoalPageState extends State<AddEditGoalPage> {
  ...
  void _loadExistingGoalData() {
    ...
    // ✅ تحويل المفتاح المخزن إلى فئة مترجمة باستخدام FinancialGoal
  ...
  void _saveGoal() {
    ...
    try {
      ...
      // ✅ تحويل الفئة المترجمة إلى مفتاح للتخزين باستخدام FinancialGoal
      ...
      final goal = FinancialGoal(
        ...
        category: categoryKey, // ✅ تخزين المفتاح
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                // الفئة - ✅ استخدام FinancialGoal.commonCategories
                _buildDropdown<String>(
                  label: 'selectCategory'.tr,
                  value: _selectedCategory,
                  items: FinancialGoal.commonCategories, // ✅ التصحيح هنا
                  onChanged: (value) {
                ...
                _buildDropdown<GoalPriority>(
                  ...
                  displayText: (priority) {
                    return FinancialGoal.priorityToString(
                        priority); // ✅ استخدام الدالة الجديدة
                  },
                ),
                const SizedBox(height: 16),
