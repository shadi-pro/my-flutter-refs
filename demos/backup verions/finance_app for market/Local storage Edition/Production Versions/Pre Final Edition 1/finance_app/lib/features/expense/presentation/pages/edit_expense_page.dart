...
class _EditExpensePageState extends State<EditExpensePage> {
  ...
  void _initializeData() {
    ...
    // التحسين: معالجة أفضل للتاريخ
    final dateString = widget.expenseData['date']?.toString();
    _date = dateString != null && dateString.isNotEmpty
          ...
          child: Column(
            children: [
              ...
              DropdownButtonFormField<String>(
                initialValue: translatedCategory,
                decoration: InputDecoration(
              ...
              const SizedBox(height: 16),
              DropdownButtonFormField<String>(
                initialValue: translatedPaymentMethod,
                decoration: InputDecoration(
