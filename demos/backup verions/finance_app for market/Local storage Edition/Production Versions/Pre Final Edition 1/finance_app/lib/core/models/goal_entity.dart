...
class FinancialGoal {
  ...
  //  Creating Financial Goal  from Map
...
// Contribution  form   نموذج المساهمة
class Contribution {
  final String id;
  final double amount;
  final String note;
