...
void main() async {
  ...
  try {
    ...
    try {
      ...
      // 4. ✅ RUN DATA MIGRATION (NEW!) - Only if translations are ready
      try {
        ...
        print('⚠️ Data migration warning: $migrationError');
        print('⚠️ Continuing with existing data format');
      }
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (migrationCompleted) {
      // print('✅ App running with migrated data');
    } else if (translationsReady) {
      // print('⚠️ App running with existing data format');
    }
