...
class _FilterPageState extends State<FilterPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final types = ['all'.tr, 'income'.tr, 'expense'.tr]; // ✅ Changed from ['الكل', 'دخل', 'مصروف']

    return Scaffold(
      appBar: AppBar(
        title: Text('filter_transactions'.tr), // ✅ Changed from const Text('تصفية المعاملات')
        centerTitle: true,
        actions: [
          TextButton(
            onPressed: () {
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                hintText: 'search_hint'.tr, // ✅ Changed from 'ابحث بالوصف أو الفئة...'
          ...
          children: [
            Row(
              children: [
                ...
                const SizedBox(width: 8),
                Text(
                  'amount'.tr, // ✅ Changed from 'نطاق المبلغ'
                  style: const TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.bold,
                  ),
          ...
          children: [
            ...
            Obx(() {
              ...
              return Column(
                children: [
                  Text(
                    'found'.trParams({ // ✅ Changed with parameters
      ...
      children: [
        ...
        SizedBox(
          ...
          child: OutlinedButton(
            ...
            child: Text('clear_all_filters'.tr), // ✅ Changed from 'إعادة تعيين الكل'
