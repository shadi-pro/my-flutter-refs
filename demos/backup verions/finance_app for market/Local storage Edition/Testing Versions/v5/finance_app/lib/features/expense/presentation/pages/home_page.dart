...
import 'package:finance_app/features/search/presentation/controllers/search_controller.dart';
...
class HomePage extends StatelessWidget {
  ...
  final ExpenseSearchController searchController =
      Get.find<ExpenseSearchController>(); // ← تغيير هنا
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          // Navigate to [Alerts Settings Page] button
          IconButton(
          ...
          // Navigate to [Backup Page] button
          IconButton(
