...
// -------------------------------------------
  ...
  26- [BottomNavigationBar] -  [current lesson]  : 
...
// B- define a new class from  the defined private method [_MyAppState] :
class _MyAppState extends State<MyApp> with SingleTickerProviderStateMixin {
  ...
  // 4- define a [widgetList]  variable   of widgets  , to be used as assumed pages contents to  naviagte through it  :
   List<Widget>  widgetList = [ 
    Text("page 1", style : TextStyle(fontSize:30  ,  fontWeight: FontWeight.bold   , color: Colors.blue  ) ) , 
    Text("page 2", style : TextStyle(fontSize:30  ,  fontWeight: FontWeight.bold   , color: Colors.blue  ) ) , 
    Text("page 3", style : TextStyle(fontSize:30  ,  fontWeight: FontWeight.bold   , color: Colors.blue  ) ) , 
  ] ; 
    ...
    return MaterialApp(
      home: Scaffold(
        ...
        bottomNavigationBar: BottomNavigationBar(
          backgroundColor: Colors.lightBlue, // [backgroud color of the all bottom naviagation bar ]
        ...
        body: Container(
         // [this will set main container with inner padding  to set all its children in full width - instead of setting each widget ]
          ...
          // dynamic display of item of [list of widgets] according to the assigned selecteed index parameter   => by assign the defined  list variable {widgetList}  inside child of container , according to it's index by  passing the index as pre-defined variable {selectedIndex} :
           child:  widgetList.elementAt((selectedIndex)), 
        ),
      ),
    );
  }
