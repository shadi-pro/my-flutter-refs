      ...
      home: Scaffold(
        ...
        body: Container(
          ...
          child: Column(
            ...
            children: [
              // Custom button to open {Drawer} [incase of non existed appbar]  :
              Center(
                child: MaterialButton(
                  child: Text('Open Drawer'), // button content
                  textColor: Colors.white, // button content color
                  color: Colors.red, // button background color
                  onPressed: () {
                    // assign  custom function of open [Drawer] widget inside [click on button]
                    scaffoldkey.currentState!.openDrawer();
                  },
                ),
              ),

              // Cutom button to open endDrawer [incase of non exsited appbar]  :
              Center(
                child: MaterialButton(
                  // Cutom button to open {End Drawer} [incase of non existed appbar] using the defined [global key] :
                  child: Text('Open EndDrawer'), // button content
                  textColor: Colors.white, // button content color
                  color: Colors.red, // button background color
                  onPressed: () {
                    // assign  custom function of open [EndDrawer] widget inside [click on button]
