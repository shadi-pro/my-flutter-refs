...
// -------------------------------------------
  25- [Tabbar]  - part 2 -  [current lesson]  : 
...
class _MyAppState extends State<MyApp> with SingleTickerProviderStateMixin {
  ...
  // 2- define a [tabController] variable  [with datatype tabController ] to be used as value of custom of {controller} property  :
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      //   initialIndex: 3, // [the initial starting tab to be started with among  tabbar]
      //   child: Scaffold(
       // assign the defined [global key] of scaffold  -  to be used to assing custom controler -   :
       Scaffold(
          key: scaffoldkey,

          // 1- [app bar] of the Home screen :
          appBar: AppBar(
            title: Text(" tabbar widget - part 2 "),
            backgroundColor:
                Colors.lightBlue, // [ general  background  color of tabbar ]

            bottom: TabBar(
              controller: tabController, // [ the custom controller of the upper defined   {} ]
              indicatorColor:
          ...
          body: Container(
            ...
            child: TabBarView(
              // using the defined controler as custom contrtoler instead fo the default controler  :
