  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        ...
        appBar: AppBar(
          title: const Text(' Button widgets types  '),
        ),
        ...
        floatingActionButton : 
          FloatingActionButton ( 
            onPressed: () { print('Hello from the main float action button '); },
            child: Icon(Icons.add) ,
        ) ,

        // controling Loction of [floatingActionButton] using the [floatingActionButtonLocation] property  :
        floatingActionButtonLocation: FloatingActionButtonLocation.endFloat ,   // [ centerTop , centerFloat ,  endFloat, startFloat , ......    ]      
