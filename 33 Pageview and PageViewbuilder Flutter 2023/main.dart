          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: PageView(
                  // [method will be applied when page is being changed  ]
                  onPageChanged: (val) {
                    print(
                      val,
                    ); // [ printing the index of current  page when page is being changed ]
                  },
                  reverse: false, // [reversed swapging  ]
                  // physics: NeverScrollableScrollPhysics(),   // [deactivating the swaping/scroling ]
                  children: [
                    Text('page view 1'),
                    Text('page view 2'),
                    Text('page view 3'),
                    Image.asset('assetes/images.png', fit: BoxFit.cover),
                    Image.asset('assetes/images.png', fit: BoxFit.cover),
                  ],
                ),
              ),

              // B- [pageView] builder  widget :
              Container(
                height: 300,
                
                child: PageView.builder(
                
                   // [ items count inside the pageView  - with using  list length for more dynamicaly looping  - ]
                  itemCount:  imageNames.length  ,
                  
                  // [this method used to loop through iterable item inisde a given defined list  by certain index/count]   :
                  itemBuilder: (context, i) {
                    return Image.asset(imageNames[i], fit: BoxFit.cover);
                  },

                  // [method will be applied when page  view  is being changed] :
                  onPageChanged: (val) {
                    print(val ); // [ tesing   print the index of current page when page is being changed ]
                  },
