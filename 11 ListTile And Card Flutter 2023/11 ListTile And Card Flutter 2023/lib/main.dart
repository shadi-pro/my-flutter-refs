    ...
    return MaterialApp(
      home: Scaffold(
        ...
        body: Container(
          child: ListView(
            children: [
              // [ this list conineer qiwll  include 2 cards    ]
              // first card inside the [listView] :
              Card(
                // 1-  public properties of [Card] :
                color: Colors.red,
                elevation:
                    0.0, // [ break line between cards  ( 0 : this value will remove the break line )  ]
                ...
                child: ListTile(
                  enabled:
                      false, // [ ths property will control the  display of card contents +  and also will deactivate any defind mehtod on this card  ]

                  leading: Text(
                    "Card  Leading ",
                  ), // [ the top of  the main title ]
