  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        ...
        appBar: AppBar(title: const Text(' [TextField]  &  [TextFormField] widget ')),
            ...
            children: [ 
              ...
              TextField(
                decoration : InputDecoration(
                  ...
                  hintStyle:  TextStyle( color: Colors.red , fontSize: 15 ) ,  // [the formating properties for  {hintText} ] 
                  labelText: 'Username' ,   // [place holder & label text with auto subtitling effect]      
                  labelStyle: TextStyle(  color: Colors.red , fontSize: 15  )  ,   // [ the formating properties for  {labelText}]      
                  label : Text(    // [  alternative of LabelText or hintText ]
                    'Username' ,
                    style : TextStyle(  color: Colors.red , fontSize: 15  )  , 
                  ), 
                  prefix : Icon(Icons.person) ,   //  [a widget before textfield (accept any widget , but commonly an icon) ]                  
                  prefixIcon: Icon(Icons.person) ,     // [a specfic iconic widget before textfield ]
                  prefixIconColor:  Colors.lightBlue ,     // [a specfic iconic widget before textfield ]
                  prefixText:  'username : ' ,     // [a specfic texual widget before textfield - can not be removed when writing by user  - ]
                  prefixStyle: TextStyle(color: Colors.red , fontSize: 15 ,  fontWeight: FontWeight.bold   )  ,     // [ formtating property for the {prefixText} ]


                  suffix : Icon(Icons.person) ,   //  [an widget after textfield (accept any widget , but commonly an icon) ]
                  suffixIcon: Icon(Icons.person)  ,    // [a specfic iconic widget after  textfield ]
                  suffixIconColor:  Colors.lightBlue,     // [a specfic iconic widget before textfield ]
                  suffixText:  ' username' ,     // [a specfic texual widget after textfield - can not be removed when writing by user - ]
                  suffixStyle: TextStyle(color: Colors.red , fontSize: 15 , fontWeight: FontWeight.bold  )  ,   // [ formtating property for the {suffixText} ]
                  
                  filled:   true  ,  // [ required for  activating the  'fillcolor'  ]
                  fillColor:  Colors.grey  ,    // [ textField background color  ]  


                  icon: Icon(Icons.person),     // [ icon before the textfiled [not a prefix icon]  ]
              ...
              TextField(
                decoration : InputDecoration(
                  hintText: 'email' , // the place holder text 
                  hintStyle:  TextStyle( color: Colors.red , fontSize: 15 ) ,  // [the formating properties for  {hintText} ] 
                  labelText: 'EMAIL' ,   // [place holder & label text with auto subtitling effect]      
                  labelStyle: TextStyle(  color: Colors.red , fontSize: 15  )  ,   // [ the formating properties for  {labelText}]      
                  ...
                  prefix : Icon(Icons.mail) ,   //  [a widget before textfield (accept any widget , but commonly an icon) ]                  
                  prefixIcon: Icon(Icons.mail) ,     // [a specfic iconic widget before textfield ]
                  prefixIconColor:  Colors.lightBlue ,     // [a specfic iconic widget before textfield ]
                  prefixText:  'Email : ' ,     // [a specfic texual widget before textfield - can not be removed when writing by user  - ]
                  prefixStyle: TextStyle(color: Colors.red , fontSize: 15 ,  fontWeight: FontWeight.bold   )  ,     // [ formtating property for the {prefixText} ]


                  suffix : Icon(Icons.mail) ,   //  [an widget after textfield (accept any widget , but commonly an icon) ]
                  suffixIcon: Icon(Icons.mail)  ,    // [a specfic iconic widget after  textfield ]
                  suffixIconColor:  Colors.lightBlue,     // [a specfic iconic widget before textfield ]
                  suffixText:  ' Email' ,     // [a specfic texual widget after textfield - can not be removed when writing by user - ]
                  suffixStyle: TextStyle(color: Colors.red , fontSize: 15 , fontWeight: FontWeight.bold  )  ,   // [ formtating property for the {suffixText} ]
                  ...
                  icon: Icon(Icons.mail),     // [ icon before the textfiled [not a prefix icon]  ]
                  iconColor: Colors.blue,     // [ icon  color ]
